...
@section('opciones')
    <ul class="navbar-nav">
        <li class="nav-item">
        <a href="#" class="nav-link">Una opcion</a>
        </li>
        <li class="nav-item">
        <a href="#" class="nav-link">Otra</a>
        </li>
        <li class="nav-item dropdown">
        <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">otra</a>
...
@section('contenido')
<div v-for="a in mexico.municipios['Chihuahua']">@{{a}}</div>
@endsection
...
@section('codigosopcional')
    <script>
        ...
        data:{
            ...
            mexico:{
                estados:["Aguascalientes","Baja California","Baja California Sur","Campeche","Chiapas","Chihuahua","Coahuila","Colima","Distrito Federal","Durango","M\u00e9xico","Guanajuato","Guerrero","Hidalgo","Jalisco","Michoac\u00e1n","Morelos","Nayarit","Nuevo Le\u00f3n","Oaxaca","Puebla","Quer\u00e9taro","Quintana Roo","San Luis Potos\u00ed","Sinaloa","Sonora","Tabasco","Tamaulipas","Tlaxcala","Veracruz","Yucat\u00e1n","Zacatecas"],
                municipios:{"Aguascalientes" :["Aguascalientes","Asientos","Calvillo","Cosío",
