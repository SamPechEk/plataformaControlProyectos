    ...
    <div >
        ...
        <div class="card card-outline card-primary">
            <div class="card-header">
                <h3 class="card-title text-sec-gobyuc">Vamos a generar el Oficio de visto bueno del proyecto, porfavor captura los datos a continuacion:</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form" enctype="multipart/form-data" role="form" action="{{action('WordController@plantilla1')}}" method="POST" >
            {{csrf_field()}}
                <div class="card-body">
                ...
                <div  class="card-footer">
                    ...
                    <a :href="'{{URL::to('/listado/documentos')}}?idproyecto='+idproyecto" class="btn btn-cancel-gobyuc">Cancelar</a>
                </div>
            </form>
        </div>
    </div>
